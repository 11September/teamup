                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}"
                                           ...
                                           id="first_name" required min="6" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}"
                                           ...
                                           id="last_name" required min="6" data-rule-minlength="6" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="number_students" type="number"
                                           value="{{ $user->number_students }}" id="number_students" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="wrapper-access-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="expiration_date"
                                               ...
                                               id="expiration_date" required readonly>
                                    </div>
                                </div>
