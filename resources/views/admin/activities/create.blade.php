...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><span>Create new Exercise</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        ...
        <form class="needs-validation" novalidate="" action="{{ action('Admin\ActivitiesController@store') }}"
              method="post">
            {{ csrf_field() }}
                ...
                <div class="col-lg-6 col-ml-12">
                    <div class="row">
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Create new Exercise</h4>
